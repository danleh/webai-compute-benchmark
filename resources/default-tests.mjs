...
export const defaultSuites = [
    ...
    {
        name: "Text Classification on wasm",
        url: "resources/transformers-js/dist/text-classification-cpu.html",
        tags: ["default", "text-classification"],
        async prepare() {},
        type: "remote",
    },
    {
        name: "Text Classification on webgpu",
        url: "resources/transformers-js/dist/text-classification-gpu.html",
        tags: ["default", "text-classification"],
        async prepare() {},
        type: "remote",
    },
